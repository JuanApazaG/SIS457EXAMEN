...
// Cross Module References
	ARCANOID02_API UClass* Z_Construct_UClass_ABall_NoRegister();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABall_GetBall_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//esto sera un componente de malla estatica que bien devuelve un componente de malla estatica  y aqui obtener bola \n" },
		{ "ModuleRelativePath", "Ball.h" },
		{ "ToolTip", "esto sera un componente de malla estatica que bien devuelve un componente de malla estatica  y aqui obtener bola" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABall_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABall_GetBall, "GetBall" }, // 3482641835
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABall_Statics::NewProp_SM_Ball_MetaData[] = {
		{ "Category", "Ball" },
		{ "Comment", "//sera visible en cualquier lugar  y va a ser un plano leido o solo \n//este sera tu componente de malla estatica que es puntero y voy a llamar a este SM_Ball\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Ball.h" },
		{ "ToolTip", "sera visible en cualquier lugar  y va a ser un plano leido o solo\neste sera tu componente de malla estatica que es puntero y voy a llamar a este SM_Ball" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABall_Statics::NewProp_ProjectileMovement_MetaData[] = {
		{ "Category", "Ball" },
		{ "Comment", "//movimiento de proyecto o un componente de movimiento de proyectiles es un puntero y lo llamare ProjectilMovement \n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Ball.h" },
		{ "ToolTip", "movimiento de proyecto o un componente de movimiento de proyectiles es un puntero y lo llamare ProjectilMovement" },
	};
#endif
	...
	IMPLEMENT_CLASS(ABall, 201874269);
	template<> ARCANOID02_API UClass* StaticClass<ABall>()
	{
		return ABall::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABall(Z_Construct_UClass_ABall, &ABall::StaticClass, TEXT("/Script/Arcanoid02"), TEXT("ABall"), false, nullptr, nullptr, nullptr);
