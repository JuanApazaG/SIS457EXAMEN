...
// Cross Module References
	ARCANOID02_API UClass* Z_Construct_UClass_APaddle_NoRegister();
	ARCANOID02_API UClass* Z_Construct_UClass_APaddle();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APaddle_Statics::NewProp_SM_Paddle_MetaData[] = {
		{ "Category", "Paddle" },
		{ "Comment", "//el visibleAnywhere es que sera visible en cualquier lugar... blueprint de solo lectura\n//componente de malla estatica puntero y lo llamara SM_Padle\x09\n//el visibleAnywhere es que sera visible en cualquier lugar... blueprint de solo lectura\n//movimiento de peon flotatne puntero y lo llamare FloatingMovement\x09usaremos esto para movernos.\n// Called when the game starts or when spawned\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Paddle.h" },
		{ "ToolTip", "el visibleAnywhere es que sera visible en cualquier lugar... blueprint de solo lectura\ncomponente de malla estatica puntero y lo llamara SM_Padle\nel visibleAnywhere es que sera visible en cualquier lugar... blueprint de solo lectura\nmovimiento de peon flotatne puntero y lo llamare FloatingMovement      usaremos esto para movernos.\n Called when the game starts or when spawned" },
	};
#endif
	...
	IMPLEMENT_CLASS(APaddle, 605443949);
	template<> ARCANOID02_API UClass* StaticClass<APaddle>()
	{
		return APaddle::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APaddle(Z_Construct_UClass_APaddle, &APaddle::StaticClass, TEXT("/Script/Arcanoid02"), TEXT("APaddle"), false, nullptr, nullptr, nullptr);
